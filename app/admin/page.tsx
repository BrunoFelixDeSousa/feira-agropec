...
import { CalendarDays, MapPin, Bell, Users } from "lucide-react"
        ...
        <TabsContent value="analytics" className="space-y-4">
          <Card className="col-span-4">
            <CardHeader>
              ...
              <CardDescription>Estatísticas detalhadas sobre o uso do site</CardDescription>
            </CardHeader>
            <CardContent className="pl-2">
              <div className="flex h-[300px] items-center justify-center border rounded-md">
                <p className="text-sm text-muted-foreground">Dados analíticos serão exibidos aqui</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
